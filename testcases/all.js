...
var framewroks = {
	...
	'Mootools': {
	    js: 'http://mootools.net/download/get/mootools-core-1.4.5-full-nocompat-yc.js',
		init:  function(window){
			window.el = window.$("header");
			window.fn = fn;
		}
	...
	'jPlusUI': {
		js: [
			'http://jplusui.github.com/jplusui/src/System/Core/assets/scripts/Base.js',
			'http://jplusui.github.com/jplusui/src/System/Dom/assets/scripts/Base.js'
		],
		init:  function(window){
...
var cases = {
	...
	'位置 - 计算':{
		jPlusUI: 'el.getPosition()',
		Mootools: 'el.getPosition()',
		jQuery: 'el.position()'
	},
	'位置 - 设置':{
		jPlusUI: 'el.setPosition(3,4)',
		Mootools: '-',
